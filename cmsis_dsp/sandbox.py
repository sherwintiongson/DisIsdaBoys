...
Noise1Freq = 32000
Noise1ScaleFactor = 350
Noise1 = np.sin(2 * np.pi * Noise1Freq * t) * Noise1ScaleFactor

Noise2Freq = 64000
Noise2ScaleFactor = 100
Noise2 = np.sin(2 * np.pi * Noise2Freq * t) * Noise2ScaleFactor

np.random.seed(0)
Noise3ScaleFactor = 100
Noise3 = np.random.randn(SampleSize) * Noise3ScaleFactor

sig_combined = np.array([2237, 2238, 2239, 2237, 2238, 2239, 2237, 2238, 2239, 2237,
                         2237, 2238, 2239, 2237, 2238, 2239, 2237, 2238, 2239, 2237,
                         2237, 2238, 2239, 2237, 2238, 2239, 2237, 2238, 2239, 2237,
                         2237, 2238])
